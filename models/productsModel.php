...
class ProductsModel {
    ...
    function getAllProducts() { // trae todos los productos
    ...
    function getProduct($id){ //trae un producto
    ...
    function getByCategory($id){ // trae todos los productos de una categoria
